...
Se sabe que la media de la duración de las canciones que tienen contenido *explicit* es M. Entonces, en base a esta premisa planteamos las siguientes hipótesis.

**1. Hipótesis nula:**

La media de la duración de las canciones explicit es menor o igual que la media de las canciones con mayor cantidad de reproducciones.

**2. Hipótesis alternativa:**

La media de la duración de las canciones *explicit* es mayor que la media de las canciones con mayor cantidad de reproducciones.
